...
ifeq ($(ENABLE_ENCRYPTION),true)
    LINEAGE_BUILD := $(PRODUCT_DEVICE)-Encrypted
else
    LINEAGE_BUILD := $(PRODUCT_DEVICE)-Decrypted
endif

AVIUM_SETTINGS_SOC_MODEL_NAME := SDM845
AVIUM_SETTINGS_DEVICE_CODENAME := MI 8
# GMS
WITH_GMS := true
...
PRODUCT_MAINLINE_BLUETOOTH_SEPOLICY_DEV_CERTIFICATES := keys
